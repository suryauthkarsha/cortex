  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col relative overflow-hidden font-sans selection:bg-white/20">
      ...
      <main className="relative z-10 flex-1 container mx-auto px-6 py-4 flex flex-col lg:flex-row gap-8 h-[calc(100vh-100px)]">
        ...
        {/* LEFT COLUMN: Tools (Desktop) - Hidden in Results Mode */}
        ...
        {/* MOBILE: Upload & Camera - Only on Mobile */}
        {viewState !== 'results' && viewState !== 'infographic' && (
          <div className="lg:hidden flex gap-3 items-center">
            <label className="p-3 rounded-full hover:bg-white/10 text-neutral-400 hover:text-white cursor-pointer transition-all bg-neutral-900/30 border border-white/5">
            ...
            <button 
              ...
              className={`p-3 rounded-full transition-all ${isSelfieMode ? 'bg-white text-black' : 'hover:bg-white/10 text-neutral-400 hover:text-white bg-neutral-900/30 border border-white/5'}`}
            >

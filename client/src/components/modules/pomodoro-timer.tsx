  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <div className={`text-6xl font-bold font-mono tracking-tight transition-colors ${
      ...
      <div className="flex items-center justify-center gap-3">
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={handleStart}
          className="bg-white text-black p-3 rounded-full hover:shadow-lg transition-shadow"
        >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={handleReset}
          className="bg-neutral-800 text-white p-3 rounded-full hover:bg-neutral-700 transition-colors"
        >
      ...
      <AnimatePresence>
        {showSettings && (
          <motion.div
            ...
            className="bg-neutral-800/50 border border-white/10 rounded-2xl p-4 space-y-3"
          >
            <div>
              ...
              <input
                ...
                className="w-full bg-neutral-900/50 border border-white/10 rounded-lg px-3 py-2 text-white text-center text-sm focus:outline-none focus:border-white/30"
              />
            </div>
            ...
            <motion.button
              ...
              className="w-full bg-primary text-black font-bold py-2 rounded-lg hover:shadow-lg transition-shadow text-sm"
            >
              Save
            </motion.button>
          </motion.div>
